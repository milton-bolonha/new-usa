...
export const constitutionAmendments = [
  {
    ...
    summary:
      'Safeguards fundamental freedoms including religion, speech, press, assembly, and petition.'
  },
  {
    number: 2,
    title: 'Amendment II',
    ...
    summary: 'Affirms the right to bear arms, linking it to a well-regulated militia.'
  },
  {
    number: 3,
    title: 'Amendment III',
    ...
    summary: 'Protects private property from forced housing of soldiers.'
  },
  {
    number: 4,
    title: 'Amendment IV',
    ...
    summary:
      'Guards against unreasonable searches and seizures, requiring warrants with probable cause.'
  },
  {
    number: 5,
    title: 'Amendment V',
    ...
    summary:
      'Protects rights including indictment by grand jury, protection from double jeopardy, self-incrimination privilege, due process, and just compensation for property takings.'
  }
]

export const articles = constitutionArticles.reduce(
  (acc, article) => {
